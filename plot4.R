...
par(mfrow = c(2,2))
plot(data2plot$DateTime,data2plot$Global_active_power,ylab="Global Active Power",lty=1,type="l",xlab="")
plot(data2plot$DateTime,data2plot$Voltage,ylab="Voltage",lty=1,type="l",xlab="datetime")
...
plot(data2plot$DateTime,data2plot$Global_reactive_power,ylab="Global_reactive_power",lty=1,type="l",xlab="datetime")
